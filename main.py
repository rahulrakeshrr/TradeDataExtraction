...
class Trade(BaseModel):
    ...
    counterparty: str = Field(description="The counterparty the trade was executed with. May not always be available")
...
@app.get("/trades",response_model=TradesList)
...
@app.get("/trades/trade_id/{id}",response_model=Trade)
...
@app.get("/trades/counter_party/{search}",response_model=Trade)
...
@app.get("/trades/instrument_ID/{search}",response_model=Trade)
...
@app.get("/trades/instrument_Name/{search}",response_model=Trade)
...
@app.get("/trades/trader/{search}",response_model=Trade)
...
@app.get("/trades/advance_filtering",response_model=Trade)
